...
export function activityIconName(type) {
  if (type === 'ad_view' || type === 'page_view') return 'eye';
  if (type === 'visit') return 'globe';
  if (type === 'login') return 'user';
  if (type === 'logout') return 'log-out';
  if (type === 'post_ad') return 'plus-circle';
  if (type === 'edit_ad') return 'edit';
  if (type === 'search') return 'search';
  if (type === 'chat') return 'message-circle';
